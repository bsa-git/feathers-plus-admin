...
// Hooks for service `chatMessages`. (Can be re-generated.)
const commonHooks = require('feathers-hooks-common');
const { authenticate } = require('@feathersjs/authentication').hooks;
// eslint-disable-next-line no-unused-vars
const chatMessagesPopulate = require('./chat-messages.populate');
// !code: imports
//---------------
...
// eslint-disable-next-line no-unused-vars
const { create, update, patch, validateCreate, validateUpdate, validatePatch } = require('./chat-messages.validate');
// !end
