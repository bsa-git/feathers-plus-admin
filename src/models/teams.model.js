...
const mongooseSchema = require('../services/teams/teams.mongoose');
// !end
...
let moduleExports = function (app) {
  ...
  const teams = new mongooseClient.Schema(mongooseSchema, { timestamps: true });
  // !end

  let existingModel = mongooseClient.models['teams']; // needed for client/server tests
  let returns = existingModel || mongooseClient.model('teams', teams);
