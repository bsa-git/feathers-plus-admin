  ...
  <div>
    ...
    <div class="subtitle-1"><p>The Vuetify grid is heavily inspired by the
      ...
      <v-alert type="info" class="my-3">
        When using the grid system with IE11 you will need to set an explicit <kbd>height</kbd> as <kbd>min-height</kbd>
        will not
    ...
    <div class="subtitle-1">You can also designate explicitly <kbd>first</kbd> or <kbd>last</kbd> which will assign -1 or 13 values
    ...
    <div class="subtitle-1">Using the <a href="https://vuetifyjs.com/en/styles/flex/#auto-margins" target="_blank">auto margin helper utilities</a>
    ...
    <div class="subtitle-1">The <kbd>v-spacer</kbd> component is useful when you want to fill available space or make space
