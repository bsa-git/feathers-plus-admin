<template>
  <div>
    ...
    <flex-box-card :md="6">
      <v-row justify="space-around">
        <v-date-picker v-model="date1" :locale="config.locale" :show-current="false"
                       color="primary"></v-date-picker>
        <v-date-picker v-model="date2" :locale="config.locale" show-current="2013-07-13"
                       color="primary"></v-date-picker>
      </v-row>
    </flex-box-card>
      ...
      <v-row>
        ...
        <v-col cols="12" sm="6" md="4">
          ...
          >
            ...
            <v-date-picker v-model="date" :locale="config.locale" color="primary"
      ...
      <v-row>
        <v-col cols="12" lg="6">
          ...
          >
            ...
            <v-date-picker v-model="date" :locale="config.locale" no-title color="primary"
